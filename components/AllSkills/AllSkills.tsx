...
const allSkillsData: SkillItem[] = [
  ...
  // IA & Produtividade
  { category: "IA & Produtividade", skill: "Cursor AI", color: "bg-cyan-500/20 text-cyan-600 dark:text-cyan-400 border-cyan-500/30" },
  { category: "IA & Produtividade", skill: "GitHub Copilot", color: "bg-gray-500/20 text-gray-600 dark:text-gray-400 border-gray-500/30" },
  { category: "IA & Produtividade", skill: "Replit AI", color: "bg-orange-500/20 text-orange-600 dark:text-orange-400 border-orange-500/30" },
  { category: "IA & Produtividade", skill: "Claude (Anthropic)", color: "bg-purple-500/20 text-purple-600 dark:text-purple-400 border-purple-500/30" },
  { category: "IA & Produtividade", skill: "ChatGPT", color: "bg-green-500/20 text-green-600 dark:text-green-400 border-green-500/30" },
  { category: "IA & Produtividade", skill: "Codex AI", color: "bg-blue-500/20 text-blue-600 dark:text-blue-400 border-blue-500/30" },
  { category: "IA & Produtividade", skill: "Multi-Agent Systems", color: "bg-indigo-500/20 text-indigo-600 dark:text-indigo-400 border-indigo-500/30" },
  { category: "IA & Produtividade", skill: "Prompt Engineering", color: "bg-pink-500/20 text-pink-600 dark:text-pink-400 border-pink-500/30" },
  { category: "IA & Produtividade", skill: "AI-Assisted Development", color: "bg-violet-500/20 text-violet-600 dark:text-violet-400 border-violet-500/30" },
  { category: "IA & Produtividade", skill: "Code Generation AI", color: "bg-fuchsia-500/20 text-fuchsia-600 dark:text-fuchsia-400 border-fuchsia-500/30" },
  { category: "IA & Produtividade", skill: "AI Code Review", color: "bg-rose-500/20 text-rose-600 dark:text-rose-400 border-rose-500/30" },
  { category: "IA & Produtividade", skill: "Automated Testing AI", color: "bg-amber-500/20 text-amber-600 dark:text-amber-400 border-amber-500/30" },
  { category: "IA & Produtividade", skill: "AI Pair Programming", color: "bg-lime-500/20 text-lime-600 dark:text-lime-400 border-lime-500/30" },
  { category: "IA & Produtividade", skill: "Workflow Automation", color: "bg-emerald-500/20 text-emerald-600 dark:text-emerald-400 border-emerald-500/30" },
  { category: "IA & Produtividade", skill: "High-Velocity Development", color: "bg-sky-500/20 text-sky-600 dark:text-sky-400 border-sky-500/30" },
];
